...
public class Banco {
    ...
    public ListaCircular fila;             //Lista Circular
    public int consec;                     // variable donde se almacena el consecutivo
    public String[] nom = new String[10];  //String de la Lista de los nombres de la lista circular
